...
// SystemRandomNumberGeneratorBox er flyttet til Brainfit/Core/SystemRandomNumberGeneratorBox.swift
// slik at både engine (for daglig spill-utvalg) og spill (for stimulus-determinisme) kan dele den.
